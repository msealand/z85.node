...
describe('z85', function() {
	describe('#decode', function() {
		it('should decode HelloWorld correctly', function() {
		...
		it('should decode a valid string whose length is divisible by 5', function() {
			// Test a few of these
			for (var i = 1; i <= 100; i++) {
		...
		it('should not decode a valid string whose length is not divisible by 5', function() {
			// Test a few of these
			for (var i = 1; i <= 100; i++) {
				var string = "";
		...
		it('should not decode an invalid string of any length', function() {
			// Test a few of these
			for (var i = 1; i <= 10; i++) {
